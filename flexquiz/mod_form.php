...
class mod_flexquiz_mod_form extends moodleform_mod {
  ...
  function definition() {
    ...
    $sql = 'SELECT q.id, q.name FROM {quiz} AS q
    ...
    $mform->addElement('select', 'parentquiz', get_string('parentquiz', 'flexquiz'), $quizlist, array('noselectionstring' => ''));
    ...
    $mform->addElement('duration', 'customtimelimit', get_string('customtimelimit', 'flexquiz'), ['units' => [MINSECS, HOURSECS], 'optional' => true]);
    ...
    $mform->addElement('duration', 'cycleduration', get_string('cycleduration', 'flexquiz'), array('units' => [HOURSECS, DAYSECS, WEEKSECS]));

    $mform->addElement('duration', 'pauseduration', get_string('pauseduration', 'flexquiz'), ['units' => [MINSECS, HOURSECS, DAYSECS, WEEKSECS], 'optional' => true]);
  ...
  function validation($data, $files) {
    ...
    if($data['maxquestions'] && $data['maxquizcount'] &&
      ($data['maxquestions'] * $data['maxquizcount'] < sizeof($questions)))
    {
