...
class course_observers {
    ...
    public static function delete_completed_quizzes(\core\event\course_viewed $event) {
        ...
        $sql = 'SELECT cm.id,
            ...
            INNER JOIN {flexquiz_children} ac ON ac.quizid=cm.instance
        ...
        foreach ($coursemodules as $cm) {
            if (!$cm->active) {
                ...
                $description = \mod_flexquiz\childcreation\flexquiz_student_item::create_availability_info(
                    $cm->timeopen, $cm->timeclose,
                    time()
                );
            ...
            if ($hascapability) {
                ...
                foreach ($activefqs as $activefq) {
                    ...
                    ";
                        ...
                        $activefq->cmid = $cmid;
                        $fq = \mod_flexquiz\childcreation\flexquiz::create($activefq);
